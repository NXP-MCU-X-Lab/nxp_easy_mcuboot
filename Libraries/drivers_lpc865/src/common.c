...
void SWM_Config(uint32_t reg, uint32_t pin, uint32_t offset)
{
    ...
    {
        case 0:
            SWM0->PINASSIGN.PINASSIGN0 &= ~(0xFF << offset);
            SWM0->PINASSIGN.PINASSIGN0 |= (pin << offset);
            break;
        case 1:
            SWM0->PINASSIGN.PINASSIGN1 &= ~(0xFF << offset);
            SWM0->PINASSIGN.PINASSIGN1 |= (pin << offset);
            break;
        case 2:
            SWM0->PINASSIGN.PINASSIGN2 &= ~(0xFF << offset);
            SWM0->PINASSIGN.PINASSIGN2 |= (pin << offset);
            break;
        case 3:
            SWM0->PINASSIGN.PINASSIGN3 &= ~(0xFF << offset);
            SWM0->PINASSIGN.PINASSIGN3 |= (pin << offset);
            break;
        case 4:
            SWM0->PINASSIGN.PINASSIGN4 &= ~(0xFF << offset);
            SWM0->PINASSIGN.PINASSIGN4 |= (pin << offset);
            break;
        case 5:
            SWM0->PINASSIGN.PINASSIGN5 &= ~(0xFF << offset);
            SWM0->PINASSIGN.PINASSIGN5 |= (pin << offset);
            break;
        case 6:
            SWM0->PINASSIGN.PINASSIGN6 &= ~(0xFF << offset);
            SWM0->PINASSIGN.PINASSIGN6 |= (pin << offset);
            break;
        case 7:
            SWM0->PINASSIGN.PINASSIGN7 &= ~(0xFF << offset);
            SWM0->PINASSIGN.PINASSIGN7 |= (pin << offset);
            break;
    }
}
...
{
    SYSCON->MAINCLKSEL = src;                      /* Select SYSPLL input        */
