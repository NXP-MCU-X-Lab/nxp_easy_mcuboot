...
__Vectors       DCD     __initial_sp  ; Top of Stack
                ...
                DCD     iEVENT0_IRQHandler  ; iEVENT channel 0
                DCD     iEVENT1_IRQHandler  ; iEVENT channel 1
                DCD     DMA_Error_IRQHandler  ; DMA Error Interrupt
                DCD     Reserved33_IRQHandler  ; Reserved interrupt 33
                DCD     FTMRA_IRQHandler  ; FTMRA Interrupt
                DCD     Read_Collision_IRQHandler  ; Read Collision
                DCD     LVD_LVW_IRQHandler  ; Low Voltage Detect, Low Voltage Warning
                DCD     ICS_IRQHandler  ; ICS
                DCD     Watchdog_IRQHandler  ; WDOG
                DCD     ADC0_IRQHandler  ; ADC0
                DCD     ADC2_IRQHandler  ; ADC2
                DCD     SPI0_IRQHandler  ; SPI0
                DCD     SPI1_IRQHandler  ; SPI1
                DCD     I2C0_IRQHandler  ; IIC0 interrupt
                DCD     I2C1_IRQHandler  ; IIC1 interrupt
                DCD     UART0_RX_TX_IRQHandler  ; UART0 status
                DCD     UART0_ERR_IRQHandler  ; UART0 error
                DCD     UART1_RX_TX_IRQHandler  ; UART1 status
                DCD     UART1_ERR_IRQHandler  ; UART1 error
                DCD     UART2_RX_TX_IRQHandler  ; UART2 status
                DCD     UART2_ERR_IRQHandler  ; UART2 error
                DCD     UART3_RX_TX_IRQHandler  ; UART3 status
                DCD     UART3_ERR_IRQHandler  ; UART3 error
                ...
                DCD     FTM0_IRQHandler  ; FTM0
                DCD     FTM1_IRQHandler  ; FTM1
                DCD     FTM2_IRQHandler  ; FTM2
                DCD     FTM3_IRQHandler  ; FTM3
                DCD     CMT_IRQHandler  ; CMT
                DCD     PDB0_IRQHandler  ; PDB0
                DCD     PDB1_IRQHandler  ; PDB1
                DCD     PDB2_IRQHandler  ; PDB2
                DCD     PDB3_IRQHandler  ; PDB3
...
Default_Handler PROC
                ...
                EXPORT  iEVENT0_IRQHandler     [WEAK]
                EXPORT  iEVENT1_IRQHandler     [WEAK]
                EXPORT  DMA_Error_IRQHandler     [WEAK]
                EXPORT  Reserved33_IRQHandler     [WEAK]
                EXPORT  FTMRA_IRQHandler     [WEAK]
