...
typedef struct {
  ...
  __IO uint32_t SWDATAB1;                          /**< Master Read Data Byte Register, offset: 0x54 */
  ...
  __IO uint32_t MWDATAB1;                          /**< Master Read Data Byte Register, offset: 0xCC */
  union {                                          /* offset: 0xD0 */
...
/*! @name SWDATAB1 - Master Read Data Byte Register */
/*! @{ */

#define I3C_SWDATAB1_VALUE_MASK                  (0xFFU)
#define I3C_SWDATAB1_VALUE_SHIFT                 (0U)
/*! VALUE - VALUE
 */
#define I3C_SWDATAB1_VALUE(x)                    (((uint32_t)(((uint32_t)(x)) << I3C_SWDATAB1_VALUE_SHIFT)) & I3C_SWDATAB1_VALUE_MASK)
/*! @} */
...
/*! @name MWDATAB1 - Master Read Data Byte Register */
/*! @{ */
