...
/* ep defination */
#define USBD_HID0_EP_INTIN              (1)
#define USBD_HID0_EP_INTOUT             (1)
#define USBD_HID1_EP_INTIN              (2)
#define USBD_HID1_EP_INTOUT             (2)
#define USBD_HID2_EP_INTIN              (3)
#define USBD_HID2_EP_INTOUT             (3)
